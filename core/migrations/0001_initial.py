    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nume', models.CharField(max_length=255)),
                ('locatie', models.CharField(max_length=255)),
                ('tip_ferma', models.CharField(choices=[('vegetala', 'Vegetală'), ('animala', 'Animalieră'), ('mixta', 'Mixtă')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fabrica', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.fabrica')),
            ],
        ),
        migrations.CreateModel(
            name='ProductieFerma',
